    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(intent, "Complete action using"), RC_FILE_CHOOSER);
            }
        });
        ...
        mMessageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                FriendlyMessage friendlyMessage = fmList.get(i);
...
//                Intent intentpdf = new Intent(getApplicationContext(), ViewPdf.class);
//                intentpdf.putExtra("linkpdf","https://firebasestorage.googleapis.com/v0/b/share-13f4a.appspot.com/o/files%2F31?alt=media&token=64511088-a52a-4ad7-b78f-2db98e424bf8");
